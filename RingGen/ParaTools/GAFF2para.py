...
class GAFF2para:
    """
    Container for GAFF2 force field parameters
    """
    ...
    def _read_bond_prameters(self):
        bonds =  {}
        with importlib.resources.open_text('RingGen.ParaTools.GAFF2','gaff2_bonds.dat') as f:
            for line in f:
    ...
    def _read_angles_prameters(self):
        angles =  {}
        with importlib.resources.open_text('RingGen.ParaTools.GAFF2','gaff2_angles.dat') as f:
            for line in f:
                atom_1 = line[0:2].strip(" ")
                atom_2 = line[3:5].strip(" ")
    ...
    def _read_dihedrals_prameters(self):
        dihedrals =  {}
        with importlib.resources.open_text('RingGen.ParaTools.GAFF2','gaff2_dihedrals.dat') as f:
            for line in f:
                atom_1 = line[0:2].strip(" ")
                atom_2 = line[3:5].strip(" ")
                atom_3 = line[6:8].strip(" ")
    ...
    def _read_impropers_prameters(self):
        impropers =  {}
        with importlib.resources.open_text('RingGen.ParaTools.GAFF2','gaff2_impropers.dat') as f:
            for line in f:
                atom_1 = line[0:2].strip(" ")
                atom_2 = line[3:5].strip(" ")
                atom_3 = line[6:8].strip(" ")
